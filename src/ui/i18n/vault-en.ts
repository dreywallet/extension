...
export const vaultEn = {
  ...
  'vault.plan.mobileContextStep': '1. Scan the authenticated request',
  'vault.plan.mobilePsbtStep': '2. Scan the transaction',
  'vault.plan.qrPart': 'QR part {index} of {count}',
  'vault.plan.qrPause': 'Pause QR',
  'vault.plan.qrResume': 'Resume QR',
  ...
  'vault.plan.mobileResultContextStep': '1. Scan Desktop A’s approval',
  'vault.plan.mobileResultPsbtStep': '2. Scan Desktop A’s signed transaction',
